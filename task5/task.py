with open('polynominal_1.txt', 'w', encoding='utf-8') as file:
    file.write('4*x^2 + 15*x^5')
with open('polynominal_2.txt', 'w', encoding='utf-8') as file:
    file.write('3*x^4 + 5*x^6')
...
with open('summa_polynominal.txt', 'w', encoding='utf-8') as file:
